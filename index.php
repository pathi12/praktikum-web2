...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope"></i> <a href="mailto:Admin@gmail.com">Admin@gmail.com</a>
        <i class="bi bi-phone"></i> 088293593710
      </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Puskesmas Kita</a></h1>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              <h3>Why Choose Puskesmas?</h3>
              <p>
              Dapat diakses dengan mudah, terutama di daerah terpencil.
Biaya pelayanannya terjangkau atau bahkan gratis.
Menyediakan pelayanan kesehatan dasar seperti pemeriksaan, pengobatan, dan imunisasi.
Memberikan perawatan kesehatan holistik untuk seluruh anggota keluarga.
Jika diperlukan, dapat merujuk ke fasilitas kesehatan yang lebih spesialis.
Terlibat dalam kegiatan promosi kesehatan di tingkat komunitas.
Fokus pada pengobatan preventif dan pencegahan penyakit.
              </p>
    ...
    <section id="gallery" class="gallery">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Gallery</h2>
          <p>Berikut poto kegiatan-kegiatan di puskesmas kami</p>
        </div>
      </div>
