...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE dokter SET id = ?, nama = ?, gender = ?, tmp_lahir = ?, tgl_lahir = ?, kategori = ?, telpon = ?, alamat = ?, unit_kerja_id = ? WHERE id = ?";
    $stmt = $dbh->prepare($sql);
    $stmt->execute($data);
                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="id" name="id" type="text" class="form-control" value="<?= $row['kode'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="kategori" name="kategori" type="text" class="form-control" value="<?= $row['tgl_lahir'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email" class="col-4 col-form-label">Telpon</label>
                                    <div class="col-8">
                                        <input id="telpon" name="telpon" type="telpon" class="form-control" value="<?= $row['email'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="kode" class="col-4 col-form-label">Unit_kerja_id</label>
                                    <div class="col-8">
                                        <input id="unit_kerja_id" name="unit_kerja_id" type="text" class="form-control" value="<?= $row['kode'] ?>">
                                    </div>
                                </div>
                                    </div>
                                </div>
